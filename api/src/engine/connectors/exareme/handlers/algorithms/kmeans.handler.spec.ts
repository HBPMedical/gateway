...
const createExperiment = (): Experiment => ({
  ...
  domain: 'dementia:0.1',
  variables: [
    'rightphgparahippocampalgyrus,leftacgganteriorcingulategyrus,rightmcggmiddlecingulategyrus',
  ],
  coVariables: [''],
  results: [],
});
...
const data = [
  {
    ...
    centers: [
      [2.416308695652174, 0.49923478260869575, 0.6704447826086956],
      [2.8008268934531437, 4.355844159178429, 4.368724582798459],
      [3.1799977551020424, 5.278902244897958, 5.245970816326524],
    ],
  },
];
